**This software is a simulation exercise designed to solve systems of linear equations using iterative methods.**
**It provides two methods for solving these systems: Gauss-Seidel and Jacobi.**
